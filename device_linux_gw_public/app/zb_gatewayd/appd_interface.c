...
#define ZB_TEMPLATE_LEAK			"leak"
#define ZB_TEMPLATE_VALVE			"valve"
#define ZB_TEMPLATE_SMOKE			"smoke"
#define ZB_TEMPLATE_MOTION			"motion"
#define ZB_TEMPLATE_MULTI			"multi"
#define ZB_TEMPLATE_TRI_BUTTON			"button"
...
#define ZB_TEMPLATE_LEAK_VERSION		"1.0"
#define ZB_TEMPLATE_VALVE_VERSION		"1.0"
#define ZB_TEMPLATE_SMOKE_VERSION		"1.0"
#define ZB_TEMPLATE_MOTION_VERSION		"1.0"
#define ZB_TEMPLATE_MULTI_VERSION		"1.0"
...
#define ZB_DEVICE_ID_SMART_PLUG_DEVELCO 0x0001
#define ZB_DEVICE_ID_SMART_PLUG_DEVELCO1 0x0051
#define ZB_DEVICE_ID_WINDOW_DEVELCO 0x0402
#define ZB_DEVICE_ID_WINDOW_DEVELCO1 0x0001
#define ZB_DEVICE_ID_WINDOW_DEVELCO2 0x0302
...
#define ZB_DEVICE_ID_VALVE			0x0002
#define ZB_DEVICE_ID_OUTLET			0x0002
#define ZB_DEVICE_ID_LEAK			0x0402
#define ZB_DEVICE_ID_SMOKE			0x0402
#define ZB_DEVICE_ID_MOTION			0x0402
...
#define ZB_MODEL_ID_OUTLET			"outlet"
#define ZB_MODEL_ID_VALVE			"leakSMART Water Valve"
#define ZB_MODEL_ID_SMOKE			"TS0204"	
#define ZB_MODEL_ID_MOTION			"motion"
#define ZB_MODEL_ID_MULTI			"multi"
#define ZB_MODEL_ID_TRI_BUTTON			"button"
#define ZB_MODEL_ID_THERMOSTAT			"3157100"
#define ZB_MODEL_ID_CENT_PLUG			"4256050-RZHAC"
#define ZB_MODEL_ID_CENT_PLUG_1			"4257050-RZHAC"
#define ZB_MODEL_ID_LG_BULB			"B1027EB4Z01"
#define ZB_MODEL_ID_EC_BULB			"E11-G13"
#define ZB_MODEL_ID_ST_BULB			"ZBT-DIMLight-GLS0006"
#define ZB_MODEL_ID_TEMPHUMI			"TH-EM"
...
static const struct node_prop_def zb_template_smart_plug[] = {
	{ ZB_ON_OFF_PROP_NAME,		PROP_BOOLEAN,	PROP_TO_DEVICE	 },
	{ ZB_IS_ON_OFF_PROP_NAME,	PROP_BOOLEAN,	PROP_FROM_DEVICE },
...
/* Leak Valve prop define */
static const struct node_prop_def zb_template_valve[] = {
	{ ZB_ON_OFF_PROP_NAME,		PROP_BOOLEAN,	PROP_TO_DEVICE },
	{ ZB_SHORT_ADDR_PROP_NAME,	PROP_STRING,	PROP_FROM_DEVICE },
	{ ZB_LONG_ADDR_PROP_NAME,	PROP_STRING,	PROP_FROM_DEVICE },
	{ ZB_POWER_SRC_PROP_NAME,	PROP_STRING,	PROP_FROM_DEVICE },
...
static const struct node_prop_def zb_template_leak[] = {
...
static const struct node_prop_def zb_template_smoke[] = {
	...
	{ ZB_SMOKE_ALARM_TAMPER_NAME,	PROP_BOOLEAN,	PROP_FROM_DEVICE },
	{ ZB_SMOKE_ALARM_TEST_NAME,	PROP_BOOLEAN,	PROP_FROM_DEVICE },
	{ ZB_SHORT_ADDR_PROP_NAME,	PROP_STRING,	PROP_FROM_DEVICE },
	{ ZB_LONG_ADDR_PROP_NAME,	PROP_STRING,	PROP_FROM_DEVICE },
	{ ZB_POWER_SRC_PROP_NAME,	PROP_STRING,	PROP_FROM_DEVICE },
	{ ZB_BATTERY_DEFECT_NAME,	PROP_BOOLEAN,	PROP_FROM_DEVICE },
...
/* Motion detector prop define */
static const struct node_prop_def zb_template_motion[] = {
...
static const struct node_prop_def zb_template_motion_1_2[] = {
	{ ZB_STATUS_PROP_NAME,		PROP_BOOLEAN,	PROP_FROM_DEVICE },
	{ ZB_TAMPER_PROP_NAME,		PROP_BOOLEAN,	PROP_FROM_DEVICE },
	{ ZB_SHORT_ADDR_PROP_NAME,	PROP_STRING,	PROP_FROM_DEVICE },
	{ ZB_LONG_ADDR_PROP_NAME,	PROP_STRING,	PROP_FROM_DEVICE },
	{ ZB_POWER_SRC_PROP_NAME,	PROP_STRING,	PROP_FROM_DEVICE },
	{ ZB_POWER_LEV_PROP_NAME,	PROP_INTEGER,	PROP_FROM_DEVICE },
...
/* Multi detector prop define */
static const struct node_prop_def zb_template_multi[] = {
	{ ZB_STATUS_PROP_NAME,		PROP_BOOLEAN,	PROP_FROM_DEVICE },
	{ ZB_LOCAL_TEMPERATURE,		PROP_DECIMAL,	PROP_FROM_DEVICE },
	{ ZB_MEASURE_TEMPERATURE,	PROP_BOOLEAN,	PROP_TO_DEVICE	 },
	{ ZB_SHORT_ADDR_PROP_NAME,	PROP_STRING,	PROP_FROM_DEVICE },
...
/* Multi detector prop define */
static const struct node_prop_def zb_template_multi_1_1[] = {
	{ ZB_STATUS_PROP_NAME,		PROP_BOOLEAN,	PROP_FROM_DEVICE },
	{ ZB_TAMPER_PROP_NAME,		PROP_BOOLEAN,	PROP_FROM_DEVICE },
	{ ZB_SHORT_ADDR_PROP_NAME,	PROP_STRING,	PROP_FROM_DEVICE },
	{ ZB_LONG_ADDR_PROP_NAME,	PROP_STRING,	PROP_FROM_DEVICE },
...
/* Button prop define */
static const struct node_prop_def zb_template_tri_button[] = {
	{ ZB_PRESS_PROP_NAME,		PROP_INTEGER,	PROP_TO_DEVICE	 },
	{ ZB_LOCAL_TEMPERATURE,		PROP_DECIMAL,	PROP_FROM_DEVICE },
	{ ZB_SHORT_ADDR_PROP_NAME,	PROP_STRING,	PROP_FROM_DEVICE },
	{ ZB_MEASURE_TEMPERATURE,	PROP_BOOLEAN,	PROP_TO_DEVICE	 },
	{ ZB_LONG_ADDR_PROP_NAME,	PROP_STRING,	PROP_FROM_DEVICE },
...
static const struct node_prop_def zb_template_thermostat[] = {
	{ ZB_ALIAS_PROP_NAME,		PROP_STRING,	PROP_FROM_DEVICE },
...
/* Light bulb prop define */
static const struct node_prop_def zb_template_light[] = {
	{ ZB_ON_OFF_PROP_NAME,		PROP_BOOLEAN,	PROP_TO_DEVICE	 },
	{ ZB_SHORT_ADDR_PROP_NAME,	PROP_STRING,	PROP_FROM_DEVICE },
	{ ZB_LONG_ADDR_PROP_NAME,	PROP_STRING,	PROP_FROM_DEVICE },
	{ ZB_POWER_SRC_PROP_NAME,	PROP_STRING,	PROP_FROM_DEVICE },
...
/* Dimmable light bulb prop define */
static const struct node_prop_def zb_template_dimm_light[] = {
	{ ZB_ON_OFF_PROP_NAME,		PROP_BOOLEAN,	PROP_TO_DEVICE	 },
...
static const struct node_prop_def zb_template_lock[] = {
	{ ZB_PIN_PROP_NAME,		PROP_STRING,	PROP_FROM_DEVICE },
	{ ZB_USER_ID_PROP_NAME,		PROP_INTEGER,	PROP_TO_DEVICE	 },
	{ ZB_IS_LOCKED_PROP_NAME,	PROP_BOOLEAN,	PROP_FROM_DEVICE },
	{ ZB_SET_LOCKED_PROP_NAME,	PROP_BOOLEAN,	PROP_TO_DEVICE	 },
	{ ZB_ALIAS_PROP_NAME,		PROP_STRING,	PROP_FROM_DEVICE },
	{ ZB_SHORT_ADDR_PROP_NAME,	PROP_STRING,	PROP_FROM_DEVICE },
	{ ZB_LONG_ADDR_PROP_NAME,	PROP_STRING,	PROP_FROM_DEVICE },
	{ ZB_POWER_SRC_PROP_NAME,	PROP_STRING,	PROP_FROM_DEVICE },
...
static const struct node_prop_def zb_template_button[] = {
	{ ZB_PRESS_PROP_NAME,		PROP_BOOLEAN,	PROP_TO_DEVICE },
	{ ZB_ALIAS_PROP_NAME,		PROP_STRING,	PROP_FROM_DEVICE },
	{ ZB_SHORT_ADDR_PROP_NAME,	PROP_STRING,	PROP_FROM_DEVICE },
	{ ZB_LONG_ADDR_PROP_NAME,	PROP_STRING,	PROP_FROM_DEVICE },
	{ ZB_POWER_SRC_PROP_NAME,	PROP_STRING,	PROP_FROM_DEVICE },
...
static const struct node_prop_def zb_template_temphumi[] = {
	{ ZB_LOCAL_HUMIDITY,		PROP_DECIMAL,	PROP_FROM_DEVICE },
	{ ZB_LOCAL_TEMPERATURE,		PROP_DECIMAL,	PROP_FROM_DEVICE },
	{ ZB_ALIAS_PROP_NAME,		PROP_STRING,	PROP_FROM_DEVICE },
	{ ZB_SHORT_ADDR_PROP_NAME,	PROP_STRING,	PROP_FROM_DEVICE },
...
static struct nd_prop_info prop_info_array[] = {
	...
	{
		.device_id = ZB_DEVICE_ID_OUTLET,
		.model_id = ZB_MODEL_ID_OUTLET,
		.subdevice_key = ZB_SUBDEVICE,
	...
	{
		.device_id = ZB_DEVICE_ID_VALVE,
		.model_id = "House Water Valve - MDL-TBD",
		.subdevice_key = ZB_SUBDEVICE,
		.template_key = ZB_TEMPLATE_VALVE,
		.template_version = ZB_TEMPLATE_VALVE_VERSION,
		.prop_def = zb_template_valve,
	...
	},
	{
		...
		.model_id = ZB_MODEL_ID_MOTION,
		.subdevice_key = ZB_SUBDEVICE,
		.template_key = ZB_TEMPLATE_MOTION,
		.template_version = ZB_TEMPLATE_SMOKE_VERSION,
		.prop_def = zb_template_motion,
		.def_size = ARRAY_LEN(zb_template_smoke)
	},
	{
		.device_id = ZB_DEVICE_ID_MOTION,
	...
	},
	{
		...
		.prop_def = zb_template_motion_1_2,
		.def_size = ARRAY_LEN(zb_template_motion_1_2)
	},
	{
		.device_id = ZB_DEVICE_ID_MULTI,
		.model_id = ZB_MODEL_ID_MULTI,
		.subdevice_key = ZB_SUBDEVICE,
		.template_key = ZB_TEMPLATE_MULTI,
		.template_version = ZB_TEMPLATE_MULTI_VERSION,
		.prop_def = zb_template_multi,
		.def_size = ARRAY_LEN(zb_template_multi)
	},
	{
		.device_id = ZB_DEVICE_ID_MULTI,
		.model_id = "DoorSensor-EM",
		.subdevice_key = ZB_SUBDEVICE,
		.template_key = ZB_TEMPLATE_MULTI,
		.template_version = "1.1",
		.prop_def = zb_template_multi_1_1,
		.def_size = ARRAY_LEN(zb_template_multi_1_1)
	},
	{
		.device_id = ZB_DEVICE_ID_IAS_ZONE,
		.model_id = ZB_MODEL_ID_TRI_BUTTON,
		.subdevice_key = ZB_SUBDEVICE,
		.template_key = ZB_TEMPLATE_TRI_BUTTON,
		.template_version = ZB_TEMPLATE_TRI_BUTTON_VERSION,
		.prop_def = zb_template_tri_button,
		.def_size = ARRAY_LEN(zb_template_tri_button)
	},
	{
		.device_id = ZB_DEVICE_ID_THERMOSTAT,
		.model_id = ZB_MODEL_ID_THERMOSTAT,
		.subdevice_key = ZB_SUBDEVICE,
	...
	},
	{
		...
		.model_id = ZB_MODEL_ID_CENT_PLUG,
		.subdevice_key = ZB_SUBDEVICE,
		.template_key = ZB_TEMPLATE_SMART_PLUG,
		.template_version = ZB_TEMPLATE_SMART_PLUG_VERSION,
		.prop_def = zb_template_smart_plug,
	...
	{
		.device_id = ZB_DEVICE_ID_CENT_PLUG,
		.model_id = ZB_MODEL_ID_CENT_PLUG_1,
		.subdevice_key = ZB_SUBDEVICE,
		.template_key = ZB_TEMPLATE_SMART_PLUG,
		.template_version = ZB_TEMPLATE_SMART_PLUG_VERSION,
		.prop_def = zb_template_smart_plug,
	...
	{
		.device_id = ZB_DEVICE_ID_BULB,
		.model_id = ZB_MODEL_ID_LG_BULB,
		.subdevice_key = ZB_SUBDEVICE,
	...
	{
		.device_id = ZB_DEVICE_ID_LOCK,
		.model_id = "YRD226 TSDB",
		.subdevice_key = ZB_SUBDEVICE,
		.template_key = ZB_TEMPLATE_LOCK,
		.template_version = ZB_TEMPLATE_LOCK_VERSION,
		.prop_def = zb_template_lock,
		.def_size = ARRAY_LEN(zb_template_lock)
	},
	{
		.device_id = ZB_DEVICE_ID_IAS_ZONE,
		.model_id = "SOS-EM",
		.subdevice_key = ZB_SUBDEVICE,
		.template_key = ZB_TEMPLATE_BUTTON,
		.template_version = "1.1",
		.prop_def = zb_template_button,
		.def_size = ARRAY_LEN(zb_template_button)
	},
	{
		.device_id = ZB_DEVICE_ID_TEMPHUMI,
		.model_id = ZB_MODEL_ID_TEMPHUMI,
		.subdevice_key = ZB_SUBDEVICE,
	...
	{
		.device_id = ZB_DEVICE_ID_WINDOW_DEVELCO,
		.model_id = "",
		.subdevice_key = ZB_SUBDEVICE,
		.template_key = ZB_TEMPLATE_MOTION,
		.template_version = "1.0",
		...
		{
		.device_id = ZB_DEVICE_ID_WINDOW_DEVELCO1,
		.model_id = "",
		.subdevice_key = ZB_SUBDEVICE,
		.template_key = ZB_TEMPLATE_MOTION,
		.template_version = "1.0",
		...
		{
		.device_id = ZB_DEVICE_ID_WINDOW_DEVELCO2,
		.model_id = "",
		.subdevice_key = ZB_SUBDEVICE,
		.template_key = ZB_TEMPLATE_MOTION,
		.template_version = "1.0",
	...
	{
		.device_id = ZB_DEVICE_ID_SMART_PLUG_DEVELCO,
		.model_id = "",
		.subdevice_key = ZB_SUBDEVICE,
		.template_key = ZB_TEMPLATE_SMART_PLUG,
		.template_version = "1.0",
	...
	},*/
	{
		...
		.model_id = ZB_MODEL_ID_HEIMAN_PLUG,
		.subdevice_key = ZB_SUBDEVICE,
		.template_key = ZB_TEMPLATE_SMART_PLUG,
		.template_version = "1.0",
		.prop_def = zb_template_light,
		...
		{
		.device_id = ZB_DEVICE_ID_POWERSTRIP,
		.model_id = ZB_MODEL_ID_POWERSTRIP,
		.subdevice_key = ZB_SUBDEVICE,
		.template_key = ZB_TEMPLATE_SMART_PLUG,
		.template_version = "1.0",
		.prop_def = zb_template_light,
 ...
 * Get node prop info
 */
static struct nd_prop_info *appd_get_node_prop_info(
		uint16_t device_id, char *model_id)
{
	int i;
	for (i = 0; i < ARRAY_LEN(prop_info_array); i++) {
		if ((device_id == prop_info_array[i].device_id)
		    && (!strcmp(model_id, prop_info_array[i].model_id))) {
...
static struct node_prop *appd_get_node_prop(struct node *zb_node, char *name)
{
	...
	prop_info = appd_get_node_prop_info(info->device_id, info->model_id);
	if (!prop_info) {
		log_err("node %s cannot find prop info", zb_node->addr);
		return NULL;
	}

	nd_prop = node_prop_lookup(zb_node, prop_info->subdevice_key,
...
static void debug_print_node_info(const struct zb_node_info *info)
{
	...
	err = snprintf(buf, sizeof(buf), "node addr=%s, version=%s, "
 ...
 * Set node template
 */
static int appd_set_node_template(struct zb_node_info *info)
{
	struct nd_prop_info *prop_info;
	prop_info = appd_get_node_prop_info(info->device_id, info->model_id);
	if (prop_info) {
		/* Update node oem_model */
		strncpy(info->node->oem_model, prop_info->model_id,
		    GW_MAX_OEM_MODEL_SIZE - 1);
		info->node->oem_model[GW_MAX_OEM_MODEL_SIZE - 1] = '\0';

		appd_template_add(info->node, prop_info->subdevice_key,
		    prop_info->template_key, prop_info->template_version,
		    prop_info->prop_def, prop_info->def_size);
		return 0;
	} else {
		log_err("Don't support device_id = 0x%04X, model_id %s",
		    info->device_id, info->model_id);
		return -1;
	}
}
...
int appd_start_node_bind(uint16_t node_id, uint16_t cluster_id)
{
	...
	log_debug("starting node binding");

	zb_node = appd_get_node(node_id);
	info = (struct zb_node_info *)node_state_get(zb_node, STATE_SLOT_NET);

	ret = zb_node_bind_request(node_id, info->node_eui, cluster_id);
...
int appd_node_bind_control(uint16_t node_id, uint16_t cluster_id, bool onoff)
{
	...
	log_info("starting node binding state = %d", onoff);

	zb_node = appd_get_node(node_id);
	info = (struct zb_node_info *)node_state_get(zb_node, STATE_SLOT_NET);

	ret = zb_node_bind_control(node_id, info->node_eui, cluster_id, onoff);
...
/*
	...
	for (i = 0; i < (sizeof(model_name) / sizeof(model_name[0])); i++) {
		if (!strcmp(info->model_id, model_name[i].model_id)) {
			...
			/* DAVID: update OEM model */
			/*strncpy(info->node->oem_model, info->model_id,
				GW_MAX_OEM_MODEL_SIZE - 1);
			info->node->oem_model[GW_MAX_OEM_MODEL_SIZE - 1]
				= '\0';*/
			return;
		}
	}
...
/*
 * Handles Device Specific onboarding setup
 */
void appd_device_specific_complete_handler(uint16_t node_id,
					struct zb_node_info *info)
{
	if (info == NULL) {
	...
	if (!strcmp(info->alias, "lock")) {
		zb_send_lock_config_request(node_id);
	} else if (!strcmp(info->alias, "outlet")) {
...
{
	struct node *zb_node = appd_get_node(node_id);
	if (!zb_node) {
		/* node did not join local network, do nothing */
		log_debug("Cannot find node for node_id=0x%04X", node_id);
		return NULL;
	}
	return appd_get_node_prop(zb_node, prop_name);
}
...
void appd_ias_zone_status_change_handler(uint16_t node_id, uint8_t *msg)
{
	...
	bool alarm;
		log_debug("************appd_ias_zone_status_change_handler start");
...
*/
	/* Update enroll state because node maybe not send zone id request */
	appd_ias_enrolled_handler(info);
		log_debug("************appd_ias_zone_status_change_handler zone type for node %s is zone_type=0x%02X" ,zb_node->addr, info->zone_type);
		
		alarm = change->status.alarm1_opened;
		log_info("************appd_ias_zone_status_change_handler alarm1 Update sensor status(%d) for node %s",
		    alarm, zb_node->addr);
		/*if(alarm){
		...
		log_info("************appd_ias_zone_status_change_handler alarm2 Update sensor status(%d) for node %s",
		    alarm, zb_node->addr);
		/*if(alarm){
			appd_send_node_prop(zb_node, ZB_STATUS_PROP_NAME, &alarm);
		}*/
	...
	if (info->zone_type == EMBER_ZCL_IAS_ZONE_TYPE_STANDARD_CIE) {
		if (!strcmp(info->alias, "button")) {
			...
			log_info("Update sensor status(%d) for node %s",
			    alarm, zb_node->addr);
			appd_send_node_prop(zb_node, ZB_SMOKE_ALARM_PROP_NAME,
			    &alarm);
		}
	} /*else if (info->zone_type == EMBER_ZCL_IAS_ZONE_TYPE_MOTION_SENSOR) {
		bool batDef, batLow, tamper;
		batDef = change->status.battery_defect;
		batLow = change->status.battery;
		alarm = change->status.alarm1_opened;
		log_info("Update motion sensor motion(%d) for node %s",
		    alarm, zb_node->addr);
		appd_send_node_prop(zb_node, ZB_STATUS_PROP_NAME, &alarm);
		appd_send_node_prop(zb_node, ZB_BATTERY_DEFECT_NAME,
					&batDef);
		if (!strcmp(info->model_id, "SZ-PIR04N_EU")
			|| !strcmp(info->model_id, "PIR_TPV15")) {
			log_info("sending motion sensor tamper");
			tamper = change->status.tamper;
			appd_send_node_prop(zb_node, "tamper", &tamper);
		}
		appd_send_node_prop(zb_node, ZB_BATTERY_LOW_NAME, &batLow);
	}*/ else if (info->zone_type == EMBER_ZCL_IAS_ZONE_TYPE_WATER_SENSOR) {
		/*bool batDef, batLow;
		batDef = change->status.battery_defect;
		batLow = change->status.battery;*/
		if (!strcmp(info->model_id, "3315-G")){
			alarm = change->status.alarm1_opened;
			log_info("Update leak sensor status(%d) for node %s",
		    	alarm, zb_node->addr);
			appd_send_node_prop(zb_node, ZB_LEAK_ALARM_PROP_NAME, &alarm);
		}
		else{
			alarm = change->status.alarm1_opened;
			log_info("Update leak sensor status(%d) for node %s",
		...
		/*appd_send_node_prop(zb_node, ZB_BATTERY_DEFECT_NAME,
					&batDef);
		appd_send_node_prop(zb_node, ZB_BATTERY_LOW_NAME, &batLow);*/
	} /*else if (info->zone_type == EMBER_ZCL_IAS_ZONE_TYPE_FIRE_SENSOR) {
		bool tamper, test, batDef, batLow;
		alarm = change->status.alarm1_opened;
		tamper = change->status.tamper;
		test = change->status.test;
		batDef = change->status.battery_defect;
		batLow = change->status.battery;
		log_info("Update smoke sensor status(%d) for node %s",
		    alarm, zb_node->addr);
		appd_send_node_prop(zb_node, ZB_SMOKE_ALARM_PROP_NAME, &alarm);
		appd_send_node_prop(zb_node, ZB_SMOKE_ALARM_TAMPER_NAME,
					&tamper);
		appd_send_node_prop(zb_node, ZB_SMOKE_ALARM_TEST_NAME, &test);
		appd_send_node_prop(zb_node, ZB_BATTERY_DEFECT_NAME,
					&batDef);
		appd_send_node_prop(zb_node, ZB_BATTERY_LOW_NAME, &batLow);
	}*/ else if (info->zone_type == EMBER_ZCL_IAS_ZONE_TYPE_CONTACT_SWITCH) {
		alarm = change->status.alarm1_opened;
		log_info("Update door sensor status(%d) for node %s",
		    alarm, zb_node->addr);
		appd_send_node_prop(zb_node, ZB_STATUS_PROP_NAME, &alarm);
	} else if (info->zone_type == 0x8000) {
		/* NO EMBER_ZCL_IAS_ZONE_TYPE_BUTTON */
		bool batDef, batLow;
		batDef = change->status.battery_defect;
		batLow = change->status.battery;
		int pressType = change->status.alarm1_opened
			+ 2 * change->status.alarm2_opened;
		log_info("Update sensor status(%d) for node %s",
		    pressType, zb_node->addr);
		appd_send_node_prop(zb_node, ZB_PRESS_PROP_NAME, &pressType);
		appd_send_node_prop(zb_node, ZB_BATTERY_DEFECT_NAME,
					&batDef);
		appd_send_node_prop(zb_node, ZB_BATTERY_LOW_NAME, &batLow);
	} else if (info->zone_type == EMBER_ZCL_IAS_ZONE_TYPE_KEY_FOB) {
		alarm = change->status.alarm1_opened;
		log_info("Update sensor status(%d) for node %s",
		    alarm, zb_node->addr);
		appd_send_node_prop(zb_node, ZB_PRESS_PROP_NAME,
		    &alarm);
	} else if (info->zone_type == EMBER_ZCL_IAS_ZONE_TYPE_GAS_SENSOR) {
		alarm = change->status.alarm1_opened;
		log_info("Update gas/smoke sensor status(%d) for node %s",
		    alarm, zb_node->addr);
		appd_send_node_prop(zb_node, ZB_STATUS_PROP_NAME, &alarm);
	} else if (info->zone_type == EMBER_ZCL_IAS_ZONE_TYPE_FIRE_SENSOR) {
		alarm = change->status.alarm1_opened;
		log_info("Update fire sensor status(%d) for node %s",
		    alarm, zb_node->addr);
		appd_send_node_prop(zb_node, ZB_STATUS_PROP_NAME, &alarm);
	}  else if (info->zone_type == EMBER_ZCL_IAS_ZONE_TYPE_MOTION_SENSOR) {
		if (!strcmp(info->model_id, "3328-G")){
			alarm = change->status.alarm2_opened;
			log_info("Update motion sensor motion(%d) for node %s",
		    	alarm, zb_node->addr);
			appd_send_node_prop(zb_node, ZB_STATUS_PROP_NAME, &alarm);
		...
		log_info("Unknown zone_type %d attempted to update",
			info->zone_type);
	}
			...
			uint8_t status, bool unbind)
{
	...
	} else if (info->device_id == ZB_DEVICE_ID_LOCK) {
		log_debug("sending post-bind lock state request");
		zb_send_read_lock_state_request(node_id);
	} else if (info->device_id == ZB_DEVICE_ID_OUTLET
		|| info->device_id == ZB_DEVICE_ID_CENT_PLUG) {
		log_debug("sending post-bind one-off state request");
