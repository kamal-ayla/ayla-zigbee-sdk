...
#ifndef __APP_EMBER_H__
#define __APP_EMBER_H__
...
#define ZCL_USING_APPLIANCE_CONTROL_CLUSTER_CLIENT
...
#define EMBER_AF_APPLIANCE_CONTROL_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
