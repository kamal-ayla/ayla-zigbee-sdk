	...
	DBusMessage *msg)
{
	const char *val;
	/*
	log_debug("filter->type %d, msg type: %d",
	    filter->type, dbus_message_get_type(msg));
	log_debug("filter->sender %s, msg sender: %s",
	    filter->sender, dbus_message_get_sender(msg));
	log_debug("filter->interface %s, msg interface: %s",
	    filter->interface, dbus_message_get_interface(msg));
	log_debug("filter->member %s, msg member: %s",
	    filter->member, dbus_message_get_member(msg));
	log_debug("filter->path %s, msg path: %s",
	    filter->path, dbus_message_get_path(msg));
	log_debug("filter->destination %s, msg destination: %s",
	    filter->destination, dbus_message_get_destination(msg));
	*/
