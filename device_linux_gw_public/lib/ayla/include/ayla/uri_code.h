...
#define URI_MAP_SIZE	(256 / (sizeof(u32) * 8))
 ...
 * (after the ?, / or ? is OK).
 */
extern const u32 uri_arg_allowed_map[URI_MAP_SIZE];

/*
 * Bitmap for printable ASCII characters (other than %):  0x20 - 0x7e.
 */
extern const u32 uri_printable_ascii_map[URI_MAP_SIZE];
