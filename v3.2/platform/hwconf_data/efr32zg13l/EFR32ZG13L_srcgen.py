...
# get module mapping
from efr32zg13l.modules.PIN.PIN_Class import *
...
from efr32zg13l.PythonSnippet.CodeGen import *
from efr32zg13l.PythonSnippet.StudioProject import *
...
def generate(context):
    ...
    for transition in modeTransitions():
        ...
        familyobj = dep.Family('efr32zg13l')
        ...
        mod_inst = RSSI_behavior.RSSI('RSSI')
        mod_inst.load_halconfig_model(available_modules, familyobj)
        module_list.append(mod_inst)
