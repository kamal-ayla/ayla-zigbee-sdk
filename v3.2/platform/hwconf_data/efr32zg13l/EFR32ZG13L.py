...
import efr32zg13l.PythonSnippet.RuntimeModel as RuntimeModel
import efr32zg13l.PythonSnippet.ExporterModel as ExporterModel
import efr32zg13l.PythonSnippet.Metadata as Metadata
import efr32zg13l.modules.PIN.PIN_Snippets as PIN_Snippets
import efr32zg13l.modules.PORTIO.PORTIO_Snippets as PORTIO_Snippets
import efr32zg13l.halconfig.halconfig_dependency as dep

import efr32zg13l.modules.ACMP0.ACMP_behavior as ACMP_behavior
import efr32zg13l.modules.ACMP1.ACMP_behavior as ACMP_behavior
import efr32zg13l.modules.ADC0.ADC_behavior as ADC_behavior
import efr32zg13l.modules.ANTDIV.ANTDIV_behavior as ANTDIV_behavior
import efr32zg13l.modules.BATTERYMON.BATTERYMON_behavior as BATTERYMON_behavior
import efr32zg13l.modules.BTL_BUTTON.BTL_BUTTON_behavior as BTL_BUTTON_behavior
import efr32zg13l.modules.BULBPWM.BULBPWM_behavior as BULBPWM_behavior
import efr32zg13l.modules.BULBPWM_COLOR.BULBPWM_COLOR_behavior as BULBPWM_COLOR_behavior
import efr32zg13l.modules.BUTTON.BUTTON_behavior as BUTTON_behavior
import efr32zg13l.modules.CMU.CMU_behavior as CMU_behavior
import efr32zg13l.modules.COEX.COEX_behavior as COEX_behavior
import efr32zg13l.modules.CS5463.CS5463_behavior as CS5463_behavior
import efr32zg13l.modules.CSEN.CSEN_behavior as CSEN_behavior
import efr32zg13l.modules.DCDC.DCDC_behavior as DCDC_behavior
import efr32zg13l.modules.EMU.EMU_behavior as EMU_behavior
import efr32zg13l.modules.EXTFLASH.EXTFLASH_behavior as EXTFLASH_behavior
import efr32zg13l.modules.EZRADIOPRO.EZRADIOPRO_behavior as EZRADIOPRO_behavior
import efr32zg13l.modules.FEM.FEM_behavior as FEM_behavior
import efr32zg13l.modules.GPIO.GPIO_behavior as GPIO_behavior
import efr32zg13l.modules.I2C0.I2C_behavior as I2C_behavior
import efr32zg13l.modules.I2C1.I2C_behavior as I2C_behavior
import efr32zg13l.modules.I2CSENSOR.I2CSENSOR_behavior as I2CSENSOR_behavior
import efr32zg13l.modules.IDAC0.IDAC_behavior as IDAC_behavior
import efr32zg13l.modules.IOEXP.IOEXP_behavior as IOEXP_behavior
import efr32zg13l.modules.LED.LED_behavior as LED_behavior
import efr32zg13l.modules.LEUART0.LEUART_behavior as LEUART_behavior
import efr32zg13l.modules.MODEM.MODEM_behavior as MODEM_behavior
import efr32zg13l.modules.PA.PA_behavior as PA_behavior
import efr32zg13l.modules.PRS.PRS_behavior as PRS_behavior
import efr32zg13l.modules.PTI.PTI_behavior as PTI_behavior
import efr32zg13l.modules.PYD1698.PYD1698_behavior as PYD1698_behavior
import efr32zg13l.modules.RSSI.RSSI_behavior as RSSI_behavior
import efr32zg13l.modules.SERIAL.SERIAL_behavior as SERIAL_behavior
import efr32zg13l.modules.SPIDISPLAY.SPIDISPLAY_behavior as SPIDISPLAY_behavior
import efr32zg13l.modules.SPINCP.SPINCP_behavior as SPINCP_behavior
import efr32zg13l.modules.TIMER0.TIMER_behavior as TIMER_behavior
import efr32zg13l.modules.TIMER1.TIMER_behavior as TIMER_behavior
import efr32zg13l.modules.UARTNCP.UARTNCP_behavior as UARTNCP_behavior
import efr32zg13l.modules.USART0.USART_behavior as USART_behavior
import efr32zg13l.modules.USART1.USART_behavior as USART_behavior
import efr32zg13l.modules.USART2.USART_behavior as USART_behavior
import efr32zg13l.modules.VCOM.VCOM_behavior as VCOM_behavior
import efr32zg13l.modules.VDAC0.VDAC_behavior as VDAC_behavior
import efr32zg13l.modules.VUART.VUART_behavior as VUART_behavior
import efr32zg13l.modules.WDOG.WDOG_behavior as WDOG_behavior
import efr32zg13l.modules.WTIMER0.WTIMER_behavior as WTIMER_behavior
import efr32zg13l.upgrade as upgrade
import efr32zg13l.upgrade.upgradeDispatch as upgradeDispatch
PROFILE = True
...
def onLoad(state):
    ...
    module_instance = RSSI_behavior.RSSI('RSSI')
    module_instance.load_halconfig_model(available_modules, familyobj)
    state.set_module_object('RSSI', module_instance)
    modules.append(module_instance)
