...
from efr32zg23.PythonSnippet.CodeGen import *
from efr32zg23.PythonSnippet.StudioProject import *
...
def generate(context):
    ...
    for transition in modeTransitions():
        ...
        familyobj = dep.Family('efr32zg23')
        ...
        mod_inst = EUSART_behavior.EUSART('EUSART0')
        mod_inst.load_halconfig_model(available_modules, familyobj)
        module_list.append(mod_inst)
        
        mod_inst = EUSART_behavior.EUSART('EUSART1')
        mod_inst.load_halconfig_model(available_modules, familyobj)
        module_list.append(mod_inst)
        
        mod_inst = EUSART_behavior.EUSART('EUSART2')
        mod_inst.load_halconfig_model(available_modules, familyobj)
        module_list.append(mod_inst)
