...
PREFIX_TO_SDID_AND_PLAT = [
    ...
    ("efm32pg22", 205, Platform.SERIES2),
    ("efr32fg23", 210, Platform.SERIES2),
    ("efr32zg23", 210, Platform.SERIES2),
    ("efm32pg23", 210, Platform.SERIES2),
    ("efr32mg24", 215, Platform.SERIES2),
