...
options = {
    "HAL_CLK_HFCLK_SOURCE": {
        ...
        "values": [
            ...
            types.EnumValue('HAL_CLK_HFCLK_SOURCE_HFRCODPLL', 'HFRCODPLL (High frequency up to 80MHz RC Oscillator)', dep.Dependency(sdid=[200,205,210,215])),
    ...
    "HAL_CLK_PLL_CONFIGURATION": {
        ...
        "values": [types.EnumValue('HAL_CLK_PLL_CONFIGURATION_40MHZ', '40MHz from LFXO', dep.Dependency(sdid=[200,210,215])),
                   types.EnumValue('HAL_CLK_PLL_CONFIGURATION_76_8MHZ', '76.8MHz from HFXO', dep.Dependency(sdid=[205,210,215])),
                   types.EnumValue('HAL_CLK_PLL_CONFIGURATION_80MHZ', '80MHz from HFXO', dep.Dependency(sdid=[200,210,215]))],
        "subcategory": "Clock Sources",
    ...
    "BSP_CLK_HFXO_FREQ": [
        {
            ...
            "subcategory": "HFXO",
            "dependency": dep.Dependency(sdid=[80,84,89,95,200,205,210,215]),
    ...
    "HAL_CLK_LFXO_PRECISION": {
        "type": "uint32_t",
        "description": "LFXO precision",
        "subcategory": "LFXO",
        "min": "0",
        "max": "65535",
        "defaultValue": "500",
        "longdescription": "LFXO precision in PPM",
        "generate_if_hidden": False,
    },
