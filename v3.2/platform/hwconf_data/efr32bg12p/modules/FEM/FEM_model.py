...
options = {
    ...
    "HAL_FEM_OPTIMIZED_PHY_ENABLE": {
        "type": "boolean",
        "description": "Enable FEM optimized PHY",
        "defaultValue": "False",
        "longdescription": "Enable FEM optimized PHY by default",
        "subcategory": "Power",
        "generate_if_hidden": False,
    },
    "HAL_FEM_RUNTIME_PHY_SELECT": {
        "type": "boolean",
        "description": "Enable runtime PHY select",
        "defaultValue": "False",
        "longdescription": "Support enabling/disabling FEM optimized at runtime",
        "subcategory": "Power",
        "generate_if_hidden": False,
    },
}
