...
#if !defined(SLI_CPC_ENDPOINT_SECURITY)
#define SLI_CPC_ENDPOINT_SECURITY                         (0) // Not yet implemented
#endif

#if defined(SL_CATALOG_BLUETOOTH_NCP_PRESENT)
#define SLI_CPC_ENDPOINT_BLUETOOTH  (1)
#else
#define SLI_CPC_ENDPOINT_BLUETOOTH  (0)
#endif

#if defined(SL_CATALOG_RAIL_NCP_PRESENT)
#define SLI_CPC_ENDPOINT_RAIL (2)
#else
#define SLI_CPC_ENDPOINT_RAIL (0)
#endif

#if defined(SL_CATALOG_ZIGBEE_NCP_PRESENT)
#define SLI_CPC_ENDPOINT_ZIGBEE (1)
#else
#define SLI_CPC_ENDPOINT_ZIGBEE (0)
#endif

#if defined(SL_CATALOG_ZWAVE_NCP_PRESENT)
#define SLI_CPC_ENDPOINT_ZWAVE  (1)
#else
#define SLI_CPC_ENDPOINT_ZWAVE  (0)
#endif

#if defined(SL_CATALOG_CONNECT_NCP_PRESENT)
#define SLI_CPC_ENDPOINT_CONNECT  (1)
#else
#define SLI_CPC_ENDPOINT_CONNECT  (0)
#endif

#if defined(SL_CATALOG_GPIO_NCP_PRESENT)
#define SLI_CPC_ENDPOINT_GPIO  (1)
#else
#define SLI_CPC_ENDPOINT_GPIO  (0)
#endif

#if defined(SL_CATALOG_OPENTHREAD_NCP_PRESENT)
#define SLI_CPC_ENDPOINT_OPENTHREAD (1)
#else
#define SLI_CPC_ENDPOINT_OPENTHREAD (0)
#endif

#if defined(SL_CATALOG_WISUN_NCP_PRESENT)
#define SLI_CPC_ENDPOINT_WISUN  (1)
#else
#define SLI_CPC_ENDPOINT_WISUN  (0)
#endif

#if defined(SL_CATALOG_WIFI_NCP_PRESENT)
#define SLI_CPC_ENDPOINT_WIFI  (1)
#else
#define SLI_CPC_ENDPOINT_WIFI  (0)
#endif

#if defined(SL_CATALOG_15_4_NCP_PRESENT)
#define SLI_CPC_ENDPOINT_15_4  (1)
#else
#define SLI_CPC_ENDPOINT_15_4  (0)
#endif

#if defined(SL_CATALOG_CLI_NCP_PRESENT)
#define SLI_CPC_ENDPOINT_CLI  (1)
#else
#define SLI_CPC_ENDPOINT_CLI  (0)
#endif
...
// This is required for unit testing (not builded for primary or secondary)
#define SL_CPC_ON_FINAL_PRESENT
#define SL_CPC_ON_POLL_PRESENT
#endif
...
#define SLI_CPC_ENDPOINT_MIN_COUNT  (SLI_CPC_ENDPOINT_SYSTEM + SLI_CPC_ENDPOINT_SECURITY)

#define SLI_CPC_ENDPOINT_INTERNAL                 (SLI_CPC_ENDPOINT_SYSTEM + SLI_CPC_ENDPOINT_SECURITY + SLI_CPC_ENDPOINT_BLUETOOTH \
                                                   + SLI_CPC_ENDPOINT_RAIL + SLI_CPC_ENDPOINT_ZIGBEE + SLI_CPC_ENDPOINT_ZWAVE       \
                                                   + SLI_CPC_ENDPOINT_CONNECT + SLI_CPC_ENDPOINT_GPIO + SLI_CPC_ENDPOINT_OPENTHREAD \
                                                   + SLI_CPC_ENDPOINT_WISUN + SLI_CPC_ENDPOINT_WIFI + SLI_CPC_ENDPOINT_CLI)

#if !defined(SLI_CPC_ENDPOINT_COUNT)
#define SLI_CPC_ENDPOINT_COUNT          (SLI_CPC_ENDPOINT_INTERNAL + SL_CPC_USER_ENDPOINT_MAX_COUNT + SLI_CPC_ENDPOINT_TEMPORARY_MAX_COUNT)
#endif
