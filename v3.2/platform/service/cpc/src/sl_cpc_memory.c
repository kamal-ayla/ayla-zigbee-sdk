...
SLI_MEM_POOL_DECLARE_BUFFER(mempool_buffer_handle,
...
SLI_MEM_POOL_DECLARE_BUFFER(mempool_endpoint,
...
SLI_MEM_POOL_DECLARE_BUFFER(mempool_rx_queue_item,
...
SLI_MEM_POOL_DECLARE_BUFFER(mempool_tx_queue_item,
...
SLI_MEM_POOL_DECLARE_BUFFER(mempool_endpoint_closed_arg_item,
